	...
	return (
		<div className="pt-16 pb-8 md:pt-24 md:pb-12 flex flex-col md:flex-row items-start gap-10 md:gap-16">
			<div className="flex flex-col gap-6 w-full md:w-auto shrink-0 animate-in fade-in slide-in-from-bottom-4 duration-700">
				<div className="relative w-32 h-32 md:w-40 md:h-40 rounded-3xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 ring-1 ring-black/10 dark:ring-white/10">
					<Image
						src="/arindam.JPG"
						alt="Arindam Roy"
						fill
				...
				<div className="flex items-center gap-3">
					<a
						...
						className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/5 dark:border-white/5 hover:border-black/10 dark:hover:border-white/10 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all"
					>
			...
			<div className="flex flex-col gap-6 w-full animate-in fade-in slide-in-from-bottom-6 duration-700 delay-150">
				<div>
					<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 dark:bg-zinc-800 border border-white/10 mb-6 group cursor-pointer hover:bg-white/10 transition-colors">
						<span className="relative flex h-2 w-2">
							<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
							<span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
						</span>
						<span className="text-xs font-medium text-zinc-500 dark:text-zinc-200">
					...
					<h2 className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 font-medium tracking-tight mb-6">
						Full Stack Developer framing the future on the web.
					</h2>

					<p className="text-base text-zinc-600 dark:text-zinc-500 leading-relaxed max-w-2xl">
				...
				<div className="mt-4">
					...
					<div className="flex flex-wrap gap-2">
						{skills.map((skill) => (
							<div
								key={skill.name}
								className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg hover:text-zinc-800 dark:hover:text-zinc-200 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors cursor-default"
							>
								<Image
									src={skill.icon}
									alt={`${skill.name} icon`}
				...
				<div className="mt-4 flex flex-wrap items-center gap-3">
					<button
						...
						className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-secondary font-medium rounded-xl hover:bg-zinc-200 transition-colors group cursor-pointer"
					>
						<Mail className="w-4 h-4" />
						Let&apos;s talk
